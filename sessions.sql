...
ALTER TABLE session_speakers
  ADD CONSTRAINT FK_sessions_TO_session_speakers
    FOREIGN KEY (session_id)
    REFERENCES sessions (id);

ALTER TABLE session_speakers
  ADD CONSTRAINT FK_speakers_TO_session_speakers
...
INSERT INTO session_speakers (session_id, speaker_id) VALUES (2, 3);
INSERT INTO session_speakers (session_id, speaker_id) VALUES (3, 3);
INSERT INTO session_speakers (session_id, speaker_id) VALUES (3, 4);
INSERT INTO session_speakers (session_id, speaker_id) VALUES (4, 2);
INSERT INTO session_speakers (session_id, speaker_id) VALUES (4, 4);
